...
class ParaCalcTest1:public QObject
{
  Q_OBJECT
public:
  ParaCalcTest1();
...
ParaCalcTest1::ParaCalcTest1()
{

}

void ParaCalcTest1::addCase()
{
...
void ParaCalcTest1::addBenchmark()
{
  QBENCHMARK{
    m_add.add(1,1);
  }
...
int calcTest1(int argc, char *argv[])
{
    ParaCalcTest1 tc;
    return QTest::qExec(&tc, argc, argv);
}

#include "calcTest1.moc"
