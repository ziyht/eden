...
#define __eatom_add8_m( p, v, mo)       __eatomic_add_fetch_8 ((__eatomic_8_t *)p, v, (mo))
#define __eatom_add16_m(p, v, mo)       __eatomic_add_fetch_16((__eatomic_16_t*)p, v, (mo))
#define __eatom_add32_m(p, v, mo)       __eatomic_add_fetch_32((__eatomic_32_t*)p, v, (mo))
#define __eatom_add64_m(p, v, mo)       __eatomic_add_fetch_64((__eatomic_64_t*)p, v, (mo))
...
#define __eatom_sub8_m( p, v, mo)       __eatomic_sub_fetch_8 ((__eatomic_8_t *)p, v, (mo))
#define __eatom_sub16_m(p, v, mo)       __eatomic_sub_fetch_16((__eatomic_16_t*)p, v, (mo))
#define __eatom_sub32_m(p, v, mo)       __eatomic_sub_fetch_32((__eatomic_32_t*)p, v, (mo))
#define __eatom_sub64_m(p, v, mo)       __eatomic_sub_fetch_64((__eatomic_64_t*)p, v, (mo))
